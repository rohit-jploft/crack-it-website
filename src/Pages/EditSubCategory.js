...
const EditSubCategory = () => {
  ...
  const { profileSetupData, setProfileSetupData, preEditExpertData } =
  ...
  useEffect(() => {
    console.log(preEditExpertData, "pre edit data")
    if (preEditExpertData && preEditExpertData.expert.expertise) {
      const skillArr = [];
      for (let skil of preEditExpertData?.expert?.expertise) {
        skillArr.push(skil._id);
      }
      console.log(skillArr, "stored skills")
      setStoreSkills(skillArr);
    }
  }, []);
  useEffect(() => {
                ...
                <div>
                  ...
                  >
                    {subCategoryData?.map((item) => {
                      return (
                        <Tab eventKey={item?._id} title={item?.title} key={item?._id}>
